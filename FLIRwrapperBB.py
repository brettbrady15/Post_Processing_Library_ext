...
This library is used to record FLIR A50 Images and process them

"""
__author__ = '{ENS Brett Brady}'
__credits__ = ['{Jared Research Group (JRG)}']
__version__ = '{1}.{0}.{0}'
__maintainer__ = '{BB}'
...
class FrameHandler_BB:
    ...
    @staticmethod
    def convert_to_C(image_result, calibration, env):
        ...
        # image_data = np.array(image_result)
        B =  calibration['B'],
        R =  calibration['R'],
        J0 = calibration['J0'],
        J1 = calibration['J1'],
        ...
        image_Radiance = (image_result - J0) / J1
...
class FLIRCAMERA:
    ...
    def get_frame(self):
        ...
        return image_result, image_result.GetTimeStamp()
